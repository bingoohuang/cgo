...
1. [u2takey/cgo-bench](https://github.com/u2takey/cgo-bench)
2. [changkun/cgo-benchmarks](https://github.com/changkun/cgo-benchmarks)
3. [Hidden Dragons of CGO: Hard-learned Lessons from Writing Go Wrappers](https://docs.yottadb.com/Presentations/DragonsofCGO.pdf)
4. [Golang与C语言相互调用](https://shenbaise9527.com/golang-c-call/)
